...
class TestBot(LiacBot):
    ...
    def on_move(self, state):
        ...
        t1 = time.time()
        eval,move = self.Call_alpha_beta(board, 2)
        t2 = time.time()
        print eval, t2-t1
...
#Alpha Beta ============================================================
    def Call_alpha_beta(self, board, depth):
        ...
        for p in range(len(board.my_pieces)):
                ...
                for move in moves:
                    ...
                    eval = self.alpha_beta(sonBoard, (depth - 1), -INFINITY, INFINITY, False)
